...
例:
  ...
  python main.py run --no-dashboard      # ダッシュボードなし
    ...
    p_analyze.add_argument("-m", "--model", default="claude-haiku-4-5-20251001", help="モデル (claude-haiku, claude-sonnet, gpt-4o-mini, etc.)")
    ...
    p_run.add_argument("-n", "--limit", type=int, default=100, help="最大マーケット数")
    p_run.add_argument("-m", "--model", default="claude-sonnet-4-6", help="LLMモデル")
    p_run.add_argument("--min-edge", type=float, default=0.05, help="最小エッジ")
